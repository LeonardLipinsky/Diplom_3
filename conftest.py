...
@pytest.fixture
@allure.title('Создание пользователя с random credits и удаляние его после теста')
...
@pytest.fixture
@allure.title('Создание пользователя и заказа')
...
@pytest.fixture
@allure.title('Передача в драйвер токена созданного пользователя')
